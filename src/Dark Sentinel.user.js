...
(function () {
	...
	function obterFiltroEscudo(hue) {
		if (hue === -1) return 'grayscale(1) brightness(1.4)';
		return 'hue-rotate(' + hue + 'deg) saturate(1.8)';
	}
	...
	function adicionarEscudoVerde(cidadeId) {
		...
		shield.style.filter = obterFiltroEscudo(hue);
	...
	function atualizarCorEscudos() {
		...
		const filtro = obterFiltroEscudo(hue);
